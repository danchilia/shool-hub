...
class Exam_model extends CI_Model
{
    ...
    public function exam_save($data)
    {
        $arrayExam = array(
            ...
            'grading_system' => isset($data['grading_system']) ? $data['grading_system'] : 'traditional',
            'mark_distribution' => isset($data['mark_distribution']) ? json_encode($data['mark_distribution']) : '[]',
            'remark' => $data['remark'],
