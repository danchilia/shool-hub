...
<div class="container-fluid">
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-<?php echo $widget; ?>">
                    <label class="form-label"><?php echo translate('payment_via'); ?> <span class="text-danger">*</span></label>
                    <?php
                    $arrayVia = array(
                        ''       => translate('select'),
                        'all'    => translate('both'),
                    ...
                    echo form_dropdown("payment_via", $arrayVia, set_value('payment_via'), "class='form-control' required data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
                    ?>
                </div>
                <div class="col-md-<?php echo $widget; ?>">
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0"><i class="fas fa-list-ol me-2"></i><?php echo translate('fees_payment_history'); ?></h6>
        </div>
        <div class="card-body p-0">
            <div class="export_title px-3 pt-2"><?php echo translate('fees_payment_history'); ?></div>
