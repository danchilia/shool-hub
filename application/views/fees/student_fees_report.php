...
@media (prefers-color-scheme:dark) {
    ...
    tr.group     { color:#fff; background:#383838 !important; }
}
...
:root[data-theme="dark"]  tr.group     { color:#fff; background:#383838 !important; }
...
:root[data-theme="light"] tr.group     { color:#000; background:#f5f5f5 !important; }
tr.odd  td:first-child,
tr.even td:first-child { padding-left:18px; }
</style>
...
<div class="container-fluid">
    <div class="card mb-3">
        <div class="card-body">
            ...
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-4">
                    <label class="form-label"><?php echo translate('student'); ?></label>
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0"><i class="fas fa-list-ol me-2"></i><?php echo translate('student_fees_reports'); ?></h6>
        </div>
        <div class="card-body p-0">
            <div class="export_title px-3 pt-2"><?php echo translate('student_fees_reports'); ?></div>
            <div class="table-responsive">
                <table class="table table-bordered table-sm mb-0" id="rowGroup">
...
$(function(){
    $('#rowGroup').DataTable({
        dom: '<"row"<"col-sm-6 mb-2"B><"col-sm-6"f>><"table-responsive"t>p',
        autoWidth: false,
        pageLength: 25,
        order: [[0, 'asc']],
        rowGroup: { dataSrc: 0 },
        ...
        buttons: [
            { extend:'copyHtml5',  text:'<i class="far fa-copy"></i>',    titleAttr:'Copy',    title:$('.export_title').html(), exportOptions:{columns:':visible'} },
            { extend:'excelHtml5', text:'<i class="fa fa-file-excel"></i>',titleAttr:'Excel',   title:$('.export_title').html(), exportOptions:{columns:':visible'} },
            { extend:'csvHtml5',   text:'<i class="fa fa-file-alt"></i>',  titleAttr:'CSV',     title:$('.export_title').html(), exportOptions:{columns:':visible'} },
            { extend:'pdfHtml5',   text:'<i class="fa fa-file-pdf"></i>',  titleAttr:'PDF',     title:$('.export_title').html(), footer:true, exportOptions:{columns:':visible'},
            ...
            { extend:'print',      text:'<i class="fa fa-print"></i>',     titleAttr:'Print',   title:$('.export_title').html(), footer:true, exportOptions:{columns:':visible'},
            ...
            { extend:'colvis',     text:'<i class="fas fa-columns"></i>',  titleAttr:'Columns', title:$('.export_title').html(), postfixButtons:['colvisRestore'] }
        ]
    });
