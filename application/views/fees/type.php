            ...
            <ul class="nav nav-tabs border-0 px-3 pt-2" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#tab-list" role="tab">
                        <i class="fas fa-list-ul me-1"></i><?php echo translate('fees_type') . ' ' . translate('list'); ?>
                    </button>
                </li>
                <?php if (get_permission('fees_type', 'is_add')): ?>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-create" role="tab">
                        <i class="far fa-edit me-1"></i><?php echo translate('add') . ' ' . translate('fees_type'); ?>
                    </button>
                </li>
                <?php endif; ?>
            </ul>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="tab-list" role="tabpanel">
                    <div class="export_title"><?php echo translate('fees_type') . ' ' . translate('list'); ?></div>
                        ...
                        <table class="table table-bordered table-hover table-sm mb-0 table-export">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th><?php echo translate('fee_code'); ?></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <a href="<?php echo base_url('fees/type_edit/' . $row['id']); ?>"
                                            class="btn btn-sm btn-outline-secondary" title="<?php echo translate('edit'); ?>">
                                            <i class="fas fa-pen-nib"></i>
                                        </a>
                                        <?php endif; ?>
                                        <?php if (get_permission('fees_type', 'is_delete')): ?>
                ...
                <div class="tab-pane fade" id="tab-create" role="tabpanel">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="type_name" value="<?php echo set_value('type_name'); ?>">
                            <span class="error small text-danger d-block"></span>
                        </div>
                        <div class="col-12">
