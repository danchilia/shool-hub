					...
					<div class="form-group">
						<div class="col-md-offset-3 col-md-6">
							<div class="alert alert-info" style="padding:10px;">
								...
								<p style="margin:0 0 2px; font-size:11px; color:#555;"><strong>Academic:</strong> PP1&ndash;Form 4 classes (3 streams), 18 subjects, 3 exam terms, CAT &amp; End-Term distributions, 3 exam halls, KCSE grading, SMS &amp; email templates, Kenyan public holidays.</p>
								<p style="margin:0 0 2px; font-size:11px; color:#555;"><strong>CBC Curriculum:</strong> Learning areas, strands, sub-strands &amp; learning outcomes (PP &ndash; Grade 9); 3 Senior Secondary Pathways (STEM, Arts &amp; Sports Science, Social Sciences) with subject areas; Holistic Development Profile &mdash; 7 domains &amp; 21 indicators (Communication, Creativity, Critical Thinking, Citizenship, Digital Literacy, Learning to Learn, Physical Health); CBC 8-level competency report card; Portfolio &amp; Project Assessment; CBC Analytics dashboard.</p>
