...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header">
            <h6 class="mb-0"><i class="fas fa-list-ol me-2"></i><?php echo translate('transitions') . ' ' . translate('repots'); ?></h6>
        </div>
        <div class="card-body p-0">
            <div class="export_title px-3 pt-2">Transaction Reports : <?php echo _d($daterange[0]); ?> To <?php echo _d($daterange[1]); ?></div>
