    ...
    <div class="card">
            ...
            <ul class="nav nav-tabs px-3 pt-2">
                <li class="nav-item">
                    <a class="nav-link active" href="#list" data-bs-toggle="tab">
                        <i class="fas fa-list-ul me-1"></i><?php echo translate('deposit') . ' ' . translate('list'); ?>
                    </a>
                </li>
                <?php if (get_permission('deposit', 'is_add')): ?>
                <li class="nav-item">
                    <a class="nav-link" href="#create" data-bs-toggle="tab">
                        <i class="far fa-edit me-1"></i><?php echo translate('add') . ' ' . translate('deposit'); ?>
                    </a>
                </li>
                <?php endif; ?>
            </ul>
        ...
        <div class="tab-content">
            ...
            <div id="list" class="tab-pane fade show active p-3">
                <div class="export_title"><?php echo translate('deposit') . ' ' . translate('list'); ?></div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    ...
                                    <a href="<?php echo base_url('accounting/voucher_deposit_edit/' . $row['id']); ?>" class="btn btn-sm btn-outline-secondary" data-bs-toggle="tooltip" title="<?php echo translate('edit'); ?>">
                                        <i class="fas fa-pen-nib"></i>
                                    </a>
                                    <?php endif; ?>
                                    <?php if (get_permission('deposit', 'is_delete')): ?>
...
$(function(){
    $('#branch_id').on('change', function(){
        ...
        $.ajax({
            ...
            type: 'POST',
            data: $.extend({'branch_id': branchID, 'type': 'income'}, csrfData),
