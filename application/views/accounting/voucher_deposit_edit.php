...
<div class="container-fluid">
    <div class="content-header mb-3">
        <a href="<?php echo base_url('accounting/voucher_deposit'); ?>" class="btn btn-sm btn-outline-secondary">
            <i class="fas fa-arrow-left me-1"></i><?php echo translate('deposit') . ' ' . translate('list'); ?>
        </a>
    </div>

    <div class="card">
        <div class="card-header">
            <h6 class="mb-0"><i class="far fa-edit me-2"></i><?php echo translate('edit') . ' ' . translate('deposit'); ?></h6>
        </div>
        <div class="card-body">
            ...
            <input type="hidden" name="voucher_old_id" value="<?php echo html_escape($deposit['id']); ?>">
            <div class="row">
                ...
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            echo form_dropdown("branch_id", $arrayBranch, $deposit['branch_id'], "class='form-control' id='branch_id' disabled data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
                            ?>
                ...
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            echo form_dropdown("account_id", $accounts_list, $deposit['account_id'], "class='form-control' id='account_id' disabled data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
                            ?>
                            <span class="error"></span>
                        </div>
                    </div>
                ...
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            echo form_dropdown("voucher_head_id", $arrayVoucherHead, $deposit['voucher_head_id'], "class='form-control' id='voucher_head_id' data-plugin-selectTwo data-width='100%'");
                            ?>
                            <span class="error"></span>
                        </div>
                    </div>
                ...
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="ref_no" value="<?php echo html_escape($deposit['ref']); ?>">
                        </div>
                    </div>
                </div>
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="amount" value="<?php echo html_escape($deposit['amount']); ?>" disabled>
                            <span class="error"></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="date" value="<?php echo set_value('date', $deposit['date']); ?>" data-plugin-datepicker data-plugin-options='{"todayHighlight":true,"endDate":"+0d"}' readonly>
                            <span class="error"></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            echo form_dropdown("pay_via", $payvia_list, $deposit['pay_via'], "class='form-control' data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'");
                            ?>
                        </div>
                    </div>
                </div>
                <div class="col-md-9 offset-md-3 mb-3">
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" name="description" rows="3"><?php echo html_escape($deposit['description']); ?></textarea>
                        </div>
                    </div>
                </div>
