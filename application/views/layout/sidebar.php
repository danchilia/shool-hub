            ...
            <ul class="nav-main">
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'cbc') echo 'nav-expanded nav-active';?>">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <?php endif; if (get_permission('cbc_sub_strands', 'is_view')): ?>
                            <li class="<?php if ($sub_page == 'cbc/sub_strands') echo 'nav-active';?>">
                                <a href="<?=base_url('cbc/sub_strands')?>">
                                    <span><i class="fas fa-caret-right"></i> Sub-Strands</span>
                                </a>
                            </li>
                            <?php endif; if (get_permission('cbc_learning_outcomes', 'is_view')): ?>
                            ...
                            <li class="<?php if ($sub_page == 'cbc/analytics') echo 'nav-active';?>">
                                <a href="<?=base_url('cbc/analytics')?>">
                                    <span><i class="fas fa-caret-right"></i> CBC Analytics</span>
                                </a>
                            </li>
                            <?php endif; ?>
                        </ul>
