...
<div class="row">
    ...
    <div class="col-md-9">
        <section class="panel">
            ...
            <form class="form-horizontal frm-submit-msg" enctype="multipart/form-data">
                ...
                <div class="panel-body">
                    <h4 class="mt-none mb-md"><i class="fas fa-image"></i> School Logos</h4>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Printing Logo <small>(invoices, receipts, payslips)</small></label>
                                <input type="file" name="branch_printing_logo" class="dropify" data-allowed-file-extensions="png jpg jpeg"
                                    data-default-file="<?=get_branch_logo($branchID, 'printing_logo')?>" data-height="120" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">Report Card Logo</label>
                                <input type="file" name="branch_report_logo" class="dropify" data-allowed-file-extensions="png jpg jpeg"
                                    data-default-file="<?=get_branch_logo($branchID, 'report_card_logo')?>" data-height="120" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">School Badge/Crest</label>
                                <input type="file" name="branch_logo" class="dropify" data-allowed-file-extensions="png jpg jpeg"
                                    data-default-file="<?=get_branch_logo($branchID, 'logo')?>" data-height="120" />
                            </div>
                        </div>
                    </div>
                </div>
